...
app.post('/api/chat', async function(req, res) {
  ...
  try {
    ...
    const isAvailabilityQ = lowerMsg.match(/availab|for rent|vacant|what unit|what prop|what home|what listing|what house|under \$|under \d|homes.*rent|rent.*home|bedroom|\d\s*bed/) && !lowerMsg.match(/[0-9]{5,6}/);
